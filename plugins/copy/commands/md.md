---
description: Copy to clipboard as Markdown. Specify what to copy, or auto-detects from context.
argument-hint: [what to copy]
---

# /copy:md - Format as Markdown

Copy data/tables/text to clipboard as standard Markdown.
...
- Tables as standard Markdown `| col |` syntax with `|---|` separator
- Bold: `**text**`
- Links: `[text](url)`
- Headers: `#`, `##`, `###`
...
After copying, show:
```
✓ Copied to clipboard (format: Markdown)
